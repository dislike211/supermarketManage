...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/sys/provider/providermodifysave.html">
			...
			<font color="red"></font>
              ...
              <div class="providerAddBtn">
                  ...
                  <input type="button" id="back" name="back" value="返回" onclick="javascript:window.history.back()">
              </div>
          </form>
      </div>
  </div>
